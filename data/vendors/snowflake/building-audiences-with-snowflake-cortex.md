---
type: 'vendor'
title: 'Building Audiences with Snowflake Cortex'
source_url: 'https://www.snowflake.com/en/developers/guides/building-audiences-with-snowflake-cortex/'
vendor: ['snowflake']
...
[Snowflake for Developers](https://www.snowflake.com/content/snowflake-site/global/en/developers)/[Guides](https://www.snowflake.com/content/snowflake-site/global/en/developers/guides)/Building Audiences with Snowflake Cortex
...
**Three intelligent Cortex Agents** (Retail, FSI, Gaming) integrated with **Snowflake CoWork**, enabling you to:

- **Interact conversationally** with your customer data through Snowflake CoWork's natural language interface
...
Navigate to [**Projects → Workspaces**](https://app.snowflake.com/_deeplink/#/workspaces?utm_source=snowflake-devrel&utm_medium=developer-guides&utm_content=building-audiences-with-snowflake-cortex&utm_cta=developer-guides-deeplink) in Snowsight and create a new SQL worksheet. Copy the complete SQL script below and execute all statements by clicking **▶ Run All** or pressing `Ctrl+Shift+Enter`.
> NOTE:
>
...
-- ----------------------------------------------------------------------------
-- Step 1.5: Setup Snowflake CoWork for Agents
-- ----------------------------------------------------------------------------
-- Create Snowflake CoWork database and schema for AI agents
...
Navigate to **AI & ML > Snowflake CoWork** and select the **Retail Customer Intelligence Agent**.

### Step 1: Quantify At-Risk Revenue

Copy and paste this into Snowflake CoWork:
...
Navigate to **AI & ML > Snowflake CoWork** and select the **FSI Customer Intelligence Agent**.
...
Navigate to **AI & ML > Snowflake CoWork** and select the **Gaming Customer Intelligence Agent**.
...
- [Snowflake CoWork Documentation](https://docs.snowflake.com/user-guide/snowflake-cortex/snowflake-intelligence?_ga=2.191660586.1400445987.1762962408-1322428164.1757697987&_gac=1.162580302.1762217442.CjwKCAiAwqHIBhAEEiwAx9cTedSfDOZVCiqeWnA8OzH_hIUccsg787q86tkyw4qJtQq1hrLSDqVInRoCgdsQAvD_BwE)
...
[Configure Semantic Models](#configure-semantic-models)

[Create Cortex Agents](#create-cortex-agents)

[Materialize Campaign Audiences](#materialize-campaign-audiences)

[Retail Campaign Walkthrough](#retail-campaign-walkthrough)

[FSI Campaign Walkthrough](#fsi-campaign-walkthrough)

[Gaming Campaign Walkthrough](#gaming-campaign-walkthrough)
