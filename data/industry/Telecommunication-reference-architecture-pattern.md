---
type: 'industry'
title: 'Telecommunication reference architecture pattern'
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/industry-specific/Telecommunication-reference-architecture-pattern.md'
vendor: []
industry: ['telecom']
data_stack: []
cloud: []
