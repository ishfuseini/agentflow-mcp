---
type: 'pattern'
title: 'Microservices with NATS messaging'
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Microservices-with-NATS-messaging.md'
vendor: []
industry: []
data_stack: ['nats']
cloud: []
