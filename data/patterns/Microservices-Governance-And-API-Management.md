---
type: 'pattern'
title: 'Microservices Governance And API Management'
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Microservices-Governance-And-API-Management.md'
vendor: []
industry: []
data_stack: []
cloud: []
