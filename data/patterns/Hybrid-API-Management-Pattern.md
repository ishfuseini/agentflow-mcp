---
type: 'pattern'
title: 'Hybrid API Management Pattern'
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Hybrid-API-Management-Pattern.md'
vendor: []
industry: []
data_stack: []
cloud: []
