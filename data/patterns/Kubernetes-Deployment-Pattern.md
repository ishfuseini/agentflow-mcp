...
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Kubernetes-Deployment-Pattern.md'
vendor: []
industry: []
data_stack: ['kubernetes']
cloud: []
constraints: []
compliance: []
region: []
