---
type: 'pattern'
title: 'Microservices without service mesh pattern'
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Microservices-without-service-mesh-pattern.md'
vendor: []
industry: []
data_stack: []
cloud: []
