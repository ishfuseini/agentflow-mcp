---
type: 'pattern'
title: 'API led Connectivity Pattern'
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/API-led-Connectivity-Pattern.md'
vendor: []
industry: []
data_stack: []
cloud: []
