---
type: 'pattern'
title: 'Event Driven Architecture Kafka Pattern'
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Event-Driven-Architecture-Kafka-Pattern.md'
vendor: []
industry: []
data_stack: ['kafka']
cloud: []
