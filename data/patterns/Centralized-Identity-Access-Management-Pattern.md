---
type: 'pattern'
title: 'Centralized Identity Access Management Pattern'
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Centralized-Identity-Access-Management-Pattern.md'
vendor: []
industry: []
data_stack: []
cloud: []
