---
type: 'pattern'
title: 'Istio Service Mesh Pattern'
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Istio-Service-Mesh-Pattern.md'
vendor: []
industry: []
data_stack: ['istio']
cloud: []
