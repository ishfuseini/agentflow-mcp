---
type: 'pattern'
title: 'Ballerina sidecar pattern microservices'
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Ballerina-sidecar-pattern-microservices.md'
vendor: ['wso2']
industry: []
data_stack: []
cloud: []
