---
type: 'pattern'
title: 'Decentralized Enterpise Architecture Pattern'
source_url: 'https://github.com/chanakaudaya/solution-architecture-patterns/blob/master/vendor-neutral/Decentralized-Enterpise-Architecture-Pattern.md'
vendor: []
industry: []
data_stack: []
cloud: []
